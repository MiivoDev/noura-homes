      ...
      <section className="bg-background py-10 lg:py-14">
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
          <div className="bg-secondary text-white p-8 lg:p-10 min-h-[260px]">
            <h2 className="font-display text-[36px] leading-[1.15] tracking-[-0.36px]">Shape Your Dream Home</h2>
          ...
          <div className="bg-secondary text-white p-8 lg:p-10 min-h-[260px]">
            <h2 className="font-display text-[36px] leading-[1.15] tracking-[-0.36px]">Built Around You</h2>
