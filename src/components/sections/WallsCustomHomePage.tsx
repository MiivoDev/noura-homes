...
const heroImage = '/walls/hero.webp?v=20260422a';
const featureImage = '/walls/gallery-09.webp?v=20260422a';
const ctaBannerImage = '/walls/gallery-10.webp?v=20260422a';

const galleryImages = [
  '/walls/gallery-01.webp?v=20260422a',
  '/walls/gallery-02.webp?v=20260422a',
  '/walls/gallery-03.webp?v=20260422a',
  '/walls/gallery-04.webp?v=20260422a',
  '/walls/gallery-05.webp?v=20260422a',
  '/walls/gallery-06.webp?v=20260422a',
  '/walls/gallery-07.webp?v=20260422a',
  '/walls/gallery-08.webp?v=20260422a',
  '/walls/gallery-09.webp?v=20260422a',
  '/walls/gallery-10.webp?v=20260422a',
  '/walls/gallery-11.webp?v=20260422a',
] as const;

export default function WallsCustomHomePage() {
  ...
  return (
    <div className="bg-background">
      <ProjectPageHero
        imageSrc={heroImage}
        imageAlt="Walls Custom Home hero"
        title="Walls Custom Home"
      ...
      <section className="bg-white py-16 lg:py-20">
        <ProjectImageTextGrid
          ...
          image={<img src={featureImage} alt="Walls living space" className={projectImageEndCaseStudyClass} />}
        >
          ...
          <p className="mt-5 text-[16px] leading-[1.6]">
            961 &amp; 963 Walls are two view homes designed and built by Noura Homes in the Coquitlam Maillardville area
            with private greenbelt in the back.
          </p>
          <p className="mt-4 text-[16px] leading-[1.6]">
            Each home is just under 3,900 sqft, with 6 bedrooms and 5 bathrooms. Main features include a 2 bedroom rental
            suite, gourmet spice kitchen, and unobstructed city views.
          </p>
        </ProjectImageTextGrid>
      </section>
