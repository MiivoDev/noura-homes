...
const heroImage = '/stewart/hero.webp?v=20260422a';
const featureImage = '/stewart/gallery-03.webp?v=20260422a';
const ctaBannerImage = '/stewart/gallery-08.webp?v=20260422a';

const galleryImages = [
  '/stewart/gallery-01.webp?v=20260422a',
  '/stewart/gallery-02.webp?v=20260422a',
  '/stewart/gallery-03.webp?v=20260422a',
  '/stewart/gallery-04.webp?v=20260422a',
  '/stewart/gallery-05.webp?v=20260422a',
  '/stewart/gallery-06.webp?v=20260422a',
  '/stewart/gallery-07.webp?v=20260422a',
  '/stewart/gallery-08.webp?v=20260422a',
  '/stewart/gallery-09.webp?v=20260422a',
] as const;

export default function StewartCustomHomePage() {
  ...
  return (
    <div className="bg-background">
      <ProjectPageHero
        imageSrc={heroImage}
        imageAlt="Stewart Custom Home hero"
        title="Stewart Custom Home"
      ...
      <section className="bg-white py-16 lg:py-20">
        <ProjectImageTextGrid
          ...
          image={<img src={featureImage} alt="Stewart living space" className={projectImageEndCaseStudyClass} />}
        >
          ...
          <p className="mt-5 text-[16px] leading-[1.6]">
            958 &amp; 960 Stewart are two view homes thoughtfully crafted by Noura Homes in the Coquitlam Maillardville
            area with lane access in the back.
          </p>
          <p className="mt-4 text-[16px] leading-[1.6]">
            Each home is just under 3,800 sqft, with 6 bedrooms and 4 bathrooms. Features include a 2 bedroom rental
            suite, an attached garage, unobstructed city views, and a walk-out basement.
          </p>
        </ProjectImageTextGrid>
      </section>
