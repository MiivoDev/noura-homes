...
const heroImage = '/robson/hero.webp?v=20260422a';
const featureImage = '/robson/gallery-02.webp?v=20260422a';
const ctaBannerImage = '/robson/gallery-07.webp?v=20260422a';

const galleryImages = [
  '/robson/gallery-01.webp?v=20260422a',
  '/robson/gallery-02.webp?v=20260422a',
  '/robson/gallery-03.webp?v=20260422a',
  '/robson/gallery-04.webp?v=20260422a',
  '/robson/gallery-05.webp?v=20260422a',
  '/robson/gallery-06.webp?v=20260422a',
  '/robson/gallery-07.webp?v=20260422a',
] as const;

export default function RobsonCustomHomePage() {
  ...
  return (
    <div className="bg-background">
      <ProjectPageHero
        imageSrc={heroImage}
        imageAlt="Robson Custom Home hero"
        title="Robson Custom Home"
      ...
      <section className="bg-white py-16 lg:py-20">
        <ProjectImageTextGrid
          ...
          image={<img src={featureImage} alt="Robson living space" className={projectImageEndCaseStudyClass} />}
        >
          ...
          <p className="mt-5 text-[16px] leading-[1.6]">
            Bring the outdoors in with this beautifully designed home that is surrounded by the lush forests of the West
            Coast.
          </p>
          <p className="mt-4 text-[16px] leading-[1.6]">
            This custom home features contemporary design nestled between majestic evergreen trees.
          </p>
        </ProjectImageTextGrid>
      </section>
