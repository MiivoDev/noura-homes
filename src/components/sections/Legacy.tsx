...
export default function Legacy() {
  return (
    <section className="relative bg-secondary text-white pt-16 md:pt-20 pb-44 md:pb-56 lg:pb-[278px] overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col">
            <motion.h2 
              ...
              className="text-[48px] font-display leading-[1.1] mb-8 lg:mb-10"
            >
              Your Vision.<br />
          ...
          <div className="flex flex-col justify-between">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
              className="space-y-6 text-white/90 text-base leading-relaxed font-light"
            >
              <p className="text-[24px] leading-[1.5]">
            ...
            <motion.div
              ...
              className="mt-10 lg:mt-auto pt-4"
            >
              <a
                href="#story"
