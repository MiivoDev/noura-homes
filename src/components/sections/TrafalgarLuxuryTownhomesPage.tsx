...
export default function TrafalgarLuxuryTownhomesPage() {
  ...
  return (
    <div className="bg-background">
      <ProjectPageHero
        imageSrc={heroImage}
        imageAlt="Trafalgar Luxury Townhomes hero"
        title="Trafalgar Luxury Townhomes"
        overlayClassName="bg-black/30"
        extraTitleClassName="max-w-[1100px]"
      />
      ...
      <section className="bg-white py-12 lg:py-14">
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16">
          ...
          <div className="mt-8">
            ...
            >
              {trafalgarGalleryImages.map((src, index) => (
                <img
                  key={src}
                  src={src}
                  alt={`Trafalgar Luxury Townhomes gallery ${index + 1}`}
          ...
          <div className="mt-8 w-full max-w-[988px] mx-auto aspect-video bg-black/5">
            {videoPlaying ? (
              ...
              <button
                ...
                aria-label="Play Trafalgar Luxury Townhomes virtual tour video"
              >
                <img
                  src={trafalgarGalleryImages[0]}
                  alt=""
