...
const heroImage = '/services/house-renovations/hero.png';
const detailImage = '/services/house-renovations/detail.png';
const ctaImage = '/Your%20dream%20home.jpg';

export default function HouseRenovationsPage() {
  return (
    <div className="bg-background">
      <ServiceHeroCard title="House Renovations" imageSrc={heroImage} imageAlt="House renovations hero">
        <p>
          Reimagine your space with Noura Homes, where vision, innovation, and craftsmanship come together to create
          homes that evolve with your life. Whether it&apos;s a full kitchen or bathroom transformation, structural
          changes, or a full home remodel, our experienced team brings the same meticulous attention to detail that
          defines every Noura home.
        </p>
        <p>
          We manage each renovation from start to finish; design, planning, construction, and finishing; ensuring a
          seamless, stress-free experience. Our team blends modern functionality, elegant design, and energy
          efficiency, elevating your space while maintaining the heart of what makes it home.
        </p>
      </ServiceHeroCard>
