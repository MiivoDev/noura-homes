...
const ctaImage = 'https://www.figma.com/api/mcp/asset/d229e745-a5bb-42d4-b5bb-a34650c50eda';
      ...
      <section className="bg-white">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-[615px_1fr] gap-16 items-center py-16 lg:py-20 px-8 lg:px-16">
          ...
          <div className="max-w-[614px]">
            ...
            <a
              href="#our-projects"
              className="mt-6 inline-flex items-center justify-center border border-primary px-5 py-2.5 text-[16px] font-medium text-primary hover:bg-primary hover:text-white transition-colors"
            >
